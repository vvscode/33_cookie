    ...
    /******/ [
      ...
      /***/ function(module, exports) {
        ...
        function findMatchedRoutes(url) {
          ...
          return routes
            .map(function(route) {
              var _replaceDynamicURLPar = replaceDynamicURLParts(
                  clean(route.route)
                ),
        ...
        Navigo.prototype = {
                  ...
                  manageHooks(
                    function() {
                      m.route.route instanceof RegExp
                        ? handler.apply(
                            undefined,
                            _toConsumableArray(m.match.slice(1, m.match.length))
                          )
          ...
          _cLoc: function _cLoc() {
            if (typeof window !== "undefined") {
              if (
                typeof window.__NAVIGO_WINDOW_LOCATION_MOCK__ !== "undefined"
              ) {
